...
export const translations = {
  en: {
    ...
    // Free AI Write
    navAiWrite: "Free AI Writer",
    aiWriteTitle: "Free AI Feed & Farm Writer",
    aiWriteSubtitle: "Generate custom feeding schedules, proposals, letters, or ask general agricultural questions instantly.",
    aiWriteTemplate: "Document Template",
    aiWriteTone: "Writing Tone",
    aiWritePrompt: "Topic or Details",
    aiWritePromptPlaceholder: "e.g. Write a feeding schedule for 200 chicks or draft a bulk order proposal...",
    aiWriteBtn: "Generate Document",
    aiWriteBtnLoading: "Generating with AI...",
    aiWriteOutputTitle: "Generated Output",
    aiWriteOutputPlaceholder: "Your AI generated text will appear here...",
    aiWriteCopy: "Copy Content",
    aiWriteDownload: "Download TXT",
    aiWriteRefineTitle: "Adjust / Refine Document",
    aiWriteRefinePlaceholder: "e.g. Translate to Amharic, make it shorter, make it more formal...",
    aiWriteRefineBtn: "Update",
    aiWriteRefineLoading: "Updating...",
    aiWriteToneProfessional: "Professional",
    aiWriteToneFriendly: "Friendly",
    aiWriteToneUrgent: "Urgent",
    aiWriteToneInformative: "Informative",
    aiWriteTemplateFeed: "Feeding Guide & Schedule",
    aiWriteTemplateProposal: "Business Proposal / Letter",
    aiWriteTemplateComplaint: "Feedback & Complaint",
    aiWriteTemplateCustom: "Custom Farming Query",
    aiWriteDetailFlockSize: "Flock / Herd Size",
    aiWriteDetailAnimal: "Animal Category",
    aiWriteDetailName: "Recipient Name",
    aiWriteDetailCompany: "Your Company / Farm Name",
  },
  am: {
    // Nav & General
    ...
    // Free AI Write
    navAiWrite: "ነፃ የ AI ጸሐፊ",
    aiWriteTitle: "ነፃ የ AI መኖ እና እርሻ ጽሑፍ ማዘጋጃ",
    aiWriteSubtitle: "የአመጋገብ እቅዶች፣ የንግድ ጥያቄዎች፣ የቅሬታ ደብዳቤዎች እና ጠቅላላ የእርሻ ጥያቄዎችን በ AI በፍጥነት ያመንጩ።",
    aiWriteTemplate: "የጽሑፍ አይነት (አብነት)",
    aiWriteTone: "የጽሑፍ ዘይቤ (ድምጽ)",
    aiWritePrompt: "ዋናው ርዕስ ወይም ዝርዝር ጉዳይ",
    aiWritePromptPlaceholder: "ምሳሌ፡ ለ 200 ጫጩቶች የአመጋገብ ሰሌዳ ያዘጋጅ ወይም የጅምላ ትዕዛዝ ደብዳቤ ጻፍ...",
    aiWriteBtn: "ጽሑፍ አዘጋጅ",
    aiWriteBtnLoading: "በ AI በመዘጋጀት ላይ...",
    aiWriteOutputTitle: "የተዘጋጀው ጽሑፍ",
    aiWriteOutputPlaceholder: "የተዘጋጀው ጽሑፍ እዚህ ይታያል...",
    aiWriteCopy: "ቅዳ",
    aiWriteDownload: "አውርድ (TXT)",
    aiWriteRefineTitle: "ጽሑፉን አስተካክል / አሻሽል",
    aiWriteRefinePlaceholder: "ምሳሌ፡ ወደ አማርኛ ተርጉምልኝ፣ አሳጥረው፣ ይበልጥ ህጋዊ አድርገው...",
    aiWriteRefineBtn: "አስተካክል",
    aiWriteRefineLoading: "በማስተካከል ላይ...",
    aiWriteToneProfessional: "ሙያዊ (Professional)",
    aiWriteToneFriendly: "ወዳጃዊ (Friendly)",
    aiWriteToneUrgent: "አስቸቋይ (Urgent)",
    aiWriteToneInformative: "መረጃ ሰጪ (Informative)",
    aiWriteTemplateFeed: "የአመጋገብ መመሪያ እና የጊዜ ሰሌዳ",
    aiWriteTemplateProposal: "የንግድ ስምምነት / የሽያጭ ደብዳቤ",
    aiWriteTemplateComplaint: "የቅሬታ እና አስተያየት ማቅረቢያ",
    aiWriteTemplateCustom: "የተለየ የእርሻ ጥያቄ",
    aiWriteDetailFlockSize: "የእንስሳቱ ብዛት",
    aiWriteDetailAnimal: "የእንስሳ አይነት",
    aiWriteDetailName: "የደብዳቤው ተቀባይ ስም",
    aiWriteDetailCompany: "የድርጅትዎ / የእርሻዎ ስም",
  }
};
